...
import { ADMIN_NAVBAR_ITEMS, CONTACT_NOTI_EVENT_TYPE, MANAGER_NAVBAR_ITEMS, STAFF_NAVBAR_ITEMS } from "../app/static";
import {
...
function NavBar({ children, hidden }) {
  ...
  useLayoutEffect(() => {
    const ws = new SockJS("http://192.168.1.9:8082/ws");
      ...
      {!hidden ? (
        ...
        >
          ...
          >
            ...
            <View style={{position: 'absolute', top: -10, right:-10, backgroundColor:"red", paddingHorizontal: 4, borderRadius: 20}}>
